...
# ==============================================================================
# =========!!!! This part is generated by patching
# !!! DO NOT EDIT THIS FILE 
# !!! USE `autobuild_test.sh` to generate this file
# =========!!!! 
conf_dir = os.path.abspath(os.path.dirname(__file__))
source_dir = os.path.join(conf_dir, 'aiida_core', 'docs', 'source')

language = 'zh_CN'
_locale_path = os.path.join(conf_dir, 'locales')
locale_dirs = [_locale_path]

_html_logo_path = os.path.join(source_dir, 'images/logo_aiida_docs.png')
_html_static_path = os.path.join(source_dir, '_static')
_rediraffe_redirects_path = os.path.join(source_dir, 'redirects.txt')
_nitpick_path = os.path.join(source_dir, 'nitpick-exceptions')

_apidoc_dir = os.path.join(source_dir, 'reference', 'apidoc')
_package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida')
...
html_static_path = [_html_static_path]
html_css_files = ['aiida-custom.css']
rediraffe_redirects = _rediraffe_redirects_path
...
with open(_nitpick_path, 'r') as handle:
    nitpick_ignore = [
